        ...
        <>
            <div className="flex flex-col items-center items-center m-2 p-2 bg-slate-100 w-80 mh-80 border-4 border-green-950 rounded-xl">
                ...
                <div className="w-full h-full flex justify-around items-center">
                    <span className="p-2 flex-1 flex justify-center">${playerPrice}</span>
                    { isInCart ? '' : <button className="border border-black p-2 flex-1" onClick={handleCartAdd}>Add to cart</button> }
